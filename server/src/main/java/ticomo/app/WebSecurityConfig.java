<<<<<<< HEAD:app/src/main/java/g5/app/WebSecurityConfig.java
package g5.app;
...
public class WebSecurityConfig { // extends WebSecurityConfigurerAdapter
    ...
    */
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .authorizeRequests()
        .antMatchers(resources).permitAll()
        .antMatchers("/", "/restauranteForm", "/crearRestaurante","/editRestaurante/{nombre}","/editRestaurante","/editRestaurante/crearRestaurante","/deleteRestaurante/{nombre}").permitAll()
        .anyRequest().authenticated()
        .and()
        .formLogin()
        .loginPage("/")
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(resources).permitAll()
				.antMatchers("/", "/index", "/cliente/signup", "/admin/admin-view", "/rider/guardarRider",
						"/restaurantes/restauranteForm", "/restaurantes/createRestaurante", "/restaurantes/editRestaurante/{nombre}", "/restaurantes/editRestaurante",
						"/editRestaurante/crearRestaurante", "/restaurantes/deleteRestaurante/{nombre}", "/platoForm", "/crearPlato","/editPlato/{id}","/editPlato","/editPlato/crearPlato","/deletePlato/{id}",
...
>>>>>>> main:server/src/main/java/ticomo/app/WebSecurityConfig.java
