...
public class Administrador extends Usuario {
	 ...
	 * 
	 * Debe permitir a los administradores gestionar la lista de restaurantes y la
	 * carta de cada uno de ellos, así como consultar los pedidos realizados y la
	 * facturación por restaurante, día y mes. También se podrá acceder a las
	 * valoraciones de restaurantes y riders
	 * 
	 * Los administradores deben tener nombre, apellidos, zona (String, ejemplo:
	 * ciudad real norte, almagro...), email (userlogin) y password.
	 */
